...
final Project lighthouseProject = Project(
  ...
  logo: 'logo_transp',
  about: [
    OctaneTextSpan(textComponents: [
      OctaneText.plainBody(
        content: "Inspired by the book ",
      ),
      OctaneText.hyperlink(
        content: "Getting Things Done: The Art of Stress-free Productivity",
  ...
  process: [
    ...
    OctaneText.plainBody(content: "@img{{figjam_launchcontext_brainstorm}}"),
    OctaneText.plainBody(content: "@img{{sprint_planning_steps}}"),
    OctaneText.plainBody(
        content:
    ...
    OctaneText.plainBody(content: "@img{{inputfieldcontroller}}"),
    OctaneText.plainBody(
        content:
    ...
    OctaneText.plainBody(content: "@img{{storable_arch}}"),
  ],
  delta: [
    OctaneText.plainBody(content: "Full crash course on Dart and Flutter"),
    OctaneText.plainBody(
        content: "designing functional, beautiful interfaces in Figma"),
    OctaneText.plainBody(content: "extensive debugging skills"),
    OctaneText.plainBody(content: "usage of Firestore as database"),
    OctaneText.plainBody(
        content: "JWT keys for securing payloads sent over the network"),
  ],
  allAssets: {
    'logo_transp':
...
Project hyperionProject = Project(
  ...
  about: [
    ...
    OctaneTextSpan(textComponents: [
      ...
      OctaneText.hyperlink(
        content: "this",
        url:
            'https://letterpress-project.web.app/#/blogules/enter_autonomic_computing',
      ),
  ...
  process: [
    ...
    OctaneTextSpan(textComponents: [
      ...
      OctaneText.hyperlink(
          content: 'blogging website',
          url:
              'https://github.com/Infinitum-Hyperion/Research-Cases/tree/main/xpress'),
      OctaneText.plainBody(
          content:
    ...
    OctaneText.plainBody(content: "@img{{thp_archs_brainstorm}}"),
    OctaneText.plainBody(
        content:
    ...
    OctaneText.plainBody(content: "@img{{hyperion_codebase_overview}}"),
    OctaneText.plainBody(
        content:
  ...
  delta: [
    OctaneText.plainBody(content: "systematic research in an unfamiliar field"),
    OctaneText.plainBody(
        content:
            "implementing complex ideas and architectures in the Dart language"),
    OctaneText.plainBody(content: "branding, UIX design"),
    OctaneText.plainBody(
        content: "app development for the Autocloud web SaaS platform"),
  ],
  allAssets: {
...
Project letterpress = Project(
  ...
  product: [
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(
          content: "https://github.com/ObsidianXVI/Letterpress,Codebase",
          url: "https://github.com/ObsidianXVI/Letterpress"),
    ]),
    OctaneText.plainBody(content: "This website")
  ],
  process: [
    OctaneText.plainBody(
        content:
  ...
  delta: [
    OctaneText.plainBody(content: "creative thinking for a new blogging model"),
    OctaneText.plainBody(content: "UIX design of the web app"),
    OctaneText.plainBody(content: "usage of Firebase Hosting"),
  ],
  allAssets: {
...
Project orca = Project(
  ...
  about: [],
  product: [
    OctaneText.plainBody(content: "I created a web app using Flutter.")
  ],
  process: [OctaneText.plainBody(content: "I just start then i finish.")],
  delta: [OctaneText.plainBody(content: "I learn a lot tho")],
  allAssets: {
...
Project affogato = Project(
  ...
  about: [
    ...
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(
          content: "https://github.com/microsoft/monaco-editor",
          url: "https://github.com/microsoft/monaco-editor"),
    ]),
    OctaneText.plainBody(content: "MonacoEditor ."),
    OctaneText.plainBody(
        content:
    ...
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(
          content: "craftinginterpreters.com",
    ...
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(content: "pub.dev", url: "https://pub.dev"),
    ]),
    OctaneText.plainBody(
        content:
  ...
  process: [
    ...
    OctaneText.plainBody(content: "- a tokeniser"),
    OctaneText.plainBody(content: "- a parser"),
    OctaneText.plainBody(content: "- an interpreter"),
    OctaneText.plainBody(content: "- optionally, a core library"),
    OctaneText.plainBody(content: "After research on "),
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(
          content:
    ...
    OctaneText.plainBody(
        content: ", the following components also became necessary:"),
    OctaneText.plainBody(
        content: "- a TextMate theme file for syntax highlighting"),
    OctaneText.plainBody(content: "- an "),
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(
          content: "https://microsoft.github.io/language-server-protocol/",
          url: "https://microsoft.github.io/language-server-protocol/"),
    ]),
    OctaneText.plainBody(content: "LSP server for static code analysis"),
    OctaneText.plainBody(
        content:
    ...
    OctaneTextSpan(textComponents: [
      OctaneText.hyperlink(content: "pub.dev", url: "http://pub.dev"),
    ]),
    OctaneText.plainBody(
        content:
  ...
  delta: [
    OctaneText.plainBody(content: "UIX design for the web editor"),
    OctaneText.plainBody(
        content:
...
Project projectRedline = Project(
...
Project octane = Project(
  name: 'Octane',
  shortDesc: 'Octane is my personal portfolio site.',
  product: [OctaneText.plainBody(content: "This live website")],
  process: [],
  delta: [
    OctaneText.plainBody(
        content:
